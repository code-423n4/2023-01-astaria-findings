...
|:----: | :---           |              :----:    |  :----:         |
|1       | Storage variables read more than once in a function can be assigned to a memory variable | 1077 | 4 |
| 2      |Redundant event | 1354| 1 |
| 3      |Uint8 is more expensive than uint256 when it takes up a whole storage slot | 1244| 3 |
| 4      |Combine 2 structs when they are almost identical | 1064| 1 |
| 5      |Pass struct with position as parameter instead of array of struct and position | 252| 1 |
| 6      |If statement is unnecessary | 735| 1 |
| 7      |Miscellaneous| 1240| 3 |

## Details
### 1 Storage variables read more than once in a function can be assigned to a memory variable
...
```
[WithdrawProxy.sol#L241-266](https://github.com/code-423n4/2023-01-astaria/blob/main/src/WithdrawProxy.sol#L241-L266)
...
Similar result can be made for struct [StrategyDetailsParam](https://github.com/code-423n4/2023-01-astaria/blob/main/src/interfaces/IAstariaRouter.sol#L101-L105) and [NewLienRequest](https://github.com/code-423n4/2023-01-astaria/blob/main/src/interfaces/IAstariaRouter.sol#L112-L121)
...
## 5 Pass struct with position as parameter instead of array of struct and position
...
minDepositAmount function avg gas saved: 735
...
The variable assets is never used and never returned. This is a big gas saver because it calls the function totalAssets which has to read from storage.
```solidity
